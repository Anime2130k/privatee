...
async (Void, citel, text) => {
  ...
  /*  await doReact("📮");*/
    ...
    try {
        ...
        await Void.sendMessage(citel.chat, { sticker: stickerBuffer2 }, { quoted: citel })
            .then((result) => {
        ...
        citel.reply("An error occurred while generating the quote sticker.");
    }
});
