...
🌍 *Owner* 🌍
ᴘʟᴜɢɪɴꜱ, ʀᴇᴍᴏᴠᴇ, ɪɴꜱᴛᴀʟʟ, ᴊᴏɪɴ, ᴜɴʙʟᴏᴄᴋ, ᴜᴊɪᴅ, ʙʟᴏᴄᴋ, ᴀᴅᴅɴᴏᴛᴇ, ᴇᴠᴀʟ, ᴅᴇʟɴᴏᴛᴇ, ᴅᴇʟᴀʟʟɴᴏᴛᴇꜱ, ʙᴀɴ, ᴀʟʟɴᴏᴛᴇꜱ, 
...
🎍 *Fun* 🎍
ꜱʜɪᴘ, ϙᴜᴇꜱᴛɪᴏɴ, ᴛʀᴜᴛʜ, ᴅᴀʀᴇ, ꜰᴀᴄᴛ, ϙᴜᴏᴛᴇꜱ, ᴅᴇꜰɪɴᴇ, 

🔰 *General* 🔰
ʜᴇʟᴘ, ᴏᴡɴᴇʀ, ꜰɪʟᴇ, ɪɴꜰᴏ, ꜱᴛᴀᴛᴜꜱ, ʀᴇᴘᴏʀᴛ, ʟᴇᴀᴅᴇʀʙᴏᴀʀᴅ, ᴘɪɴɢ, ᴀʟɪᴠᴇ, 
...
🎀 *Converter* 🎀
ᴛᴏɪᴍɢ, ꜰᴀɴᴄʏ, ᴛɪɴʏ, ᴛᴏᴀᴜᴅɪᴏ, 

🧧 *Sticker* 🧧
ᴄɪʀᴄʟᴇ, ᴄʀᴏᴘ, ʀᴏᴜɴᴅ, ꜱᴛᴇᴀʟ, 

⚡ *Downloader* ⚡
ɪɴꜱᴛᴀ, ᴛᴛꜱ, ʏᴛꜱ, ᴠɪᴅᴇᴏ, ᴘʟᴀʏ, ᴘɪɴ, ᴍᴇᴅɪᴀꜰɪʀᴇ, ᴀᴜᴅɪᴏ, ʏᴛᴍᴘ4, ʏᴛᴍᴘ3, ʏᴛᴅᴏᴄ, ᴘʟᴀʏʟɪꜱᴛ, 
...
🍫 *Group* 🍫
ꜱᴛɪᴄᴋᴇʀ, ꜱᴜᴘᴘᴏʀᴛ, ᴡᴀʀɴ, ᴛᴀɢᴀʟʟ, ʀᴇᴛʀɪᴇᴠᴇ, ʀᴡᴀʀɴ, ᴘᴏʟʟ, ᴘʀᴏꜰɪʟᴇ, ʀᴀɴᴋ, ᴘʀᴏᴍᴏᴛᴇ, ᴋɪᴄᴋ, ᴍᴇᴍᴇɢᴇɴ, ɢʀᴏᴜᴘ, ɢʀᴏᴜᴘᴘɪᴄ, ʜɪᴅᴇᴛᴀɢ, ᴀᴅᴅ, ɢᴇᴛᴊɪᴅꜱ, ᴅᴇᴍᴏᴛᴇ, ᴅᴇʟ, cʜᴇᴄᴋᴡᴀʀɴ, ʙʀᴏᴀᴅᴄᴀꜱᴛ, ᴀɴᴛɪʟɪɴᴋ, ᴀᴄᴛ, ᴅᴇᴀᴄᴛ, 

🔍 *Search* 🔍
ɴᴘᴍ, ɪᴍᴅʙ, ᴡᴇᴀᴛʜᴇʀ, ʜᴏʀᴏ, ɢᴏᴏɢʟᴇ, ɪᴍᴀɢᴇ, ᴄᴏᴜᴘʟᴇᴘᴘ, ꜱᴛᴀʟᴋ, 
...
ᴀᴍᴜᴛᴇ, ᴀᴜɴᴍᴜᴛᴇ, ᴅᴜɴᴍᴜᴛᴇ, ᴅᴍᴜᴛᴇ,`
            ...
            let buttonMessaged = {
                video: { url: "https://media.tenor.com/lUn8z2EuQ1QAAAAC/snk-mikasa-season4.gif" },
                caption: str
            };
