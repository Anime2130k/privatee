...
module.exports = {
  ...
  author:  process.env.PACK_INFO.split(";")[0] === undefined ? 'BY RONEN-BOTS' : process.env.PACK_INFO.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS === undefined ? false : process.env.AUTO_READ_STATUS,
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? 'Mikasa 💗' : process.env.PACK_INFO.split(";")[1],
  ...
  BRANCH: 'main', 
  ALIVE_MESSAGE:  process.env.ALIVE_MESSAGE === undefined ? 'Konichiwa! I am Mikasa💗 a WhatsApp Bot created by *©RONEN-BOTS*' : process.env.ALIVE_MESSAGE,
